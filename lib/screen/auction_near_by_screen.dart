...
* 작성일 : 2020.11.15
* 변경일 : 2020.11.25
* 기능 설명 : auction.dart 선택한 건물만 출력
* */
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/cupertino.dart';
import 'package:yu_market/post/search.dart';
import 'package:yu_market/post/print.dart';
import 'package:yu_market/mypage/setting.dart';

_AuctionPageState pageState;

class AuctionPage extends StatefulWidget {
  final place;
  AuctionPage({key, @required this.place}):super(key: key);
  _AuctionPageState createState() => _AuctionPageState(places: place);
}

class _AuctionPageState extends State<AuctionPage> {

  final places;
  _AuctionPageState({Key key, @required this.places});
